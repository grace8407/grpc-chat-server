...
public final class ChatServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.gits.ChatService.grpc.Chat.ChatMessage,
      com.gits.ChatService.grpc.Chat.ChatMessage> METHOD_SEND_MESSAGE = getSendMessageMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.gits.ChatService.grpc.Chat.ChatMessage,
      com.gits.ChatService.grpc.Chat.ChatMessage> getSendMessageMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.gits.ChatService.grpc.Chat.ChatMessage,
      com.gits.ChatService.grpc.Chat.ChatMessage> getSendMessageMethod() {
    return getSendMessageMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.gits.ChatService.grpc.Chat.ChatMessage,
      com.gits.ChatService.grpc.Chat.ChatMessage> getSendMessageMethodHelper() {
    io.grpc.MethodDescriptor<com.gits.ChatService.grpc.Chat.ChatMessage, com.gits.ChatService.grpc.Chat.ChatMessage> getSendMessageMethod;
      ...
      synchronized (ChatServiceGrpc.class) {
        if ((getSendMessageMethod = ChatServiceGrpc.getSendMessageMethod) == null) {
          ChatServiceGrpc.getSendMessageMethod = getSendMessageMethod = 
              io.grpc.MethodDescriptor.<com.gits.ChatService.grpc.Chat.ChatMessage, com.gits.ChatService.grpc.Chat.ChatMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "ChatService", "SendMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gits.ChatService.grpc.Chat.ChatMessage.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.gits.ChatService.grpc.Chat.ChatMessage> sendMessage(
        io.grpc.stub.StreamObserver<com.gits.ChatService.grpc.Chat.ChatMessage> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.gits.ChatService.grpc.Chat.ChatMessage,
                com.gits.ChatService.grpc.Chat.ChatMessage>(
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.gits.ChatService.grpc.Chat.getDescriptor();
    }
